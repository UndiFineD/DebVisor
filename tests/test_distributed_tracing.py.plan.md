# Planning Report: tests\test_distributed_tracing.py

Generated: 2025-12-13T18:59:40.963697
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Unit tests for distributed tracing.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- Span creation and lifecycle', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- Trace context management', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Automatic tracing decorators', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- Jaeger and Zipkin exporters', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '- Tracing middleware', expected '# limitations under the License.' |
...
File: tests\test_distributed_tracing.py
Current Description:
