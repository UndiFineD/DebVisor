# Planning Report: tests\test_dashboard.py

Generated: 2025-12-13T18:59:40.960013
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'from flask import Flask', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'from opt.web.dashboard.app import dashboard_bp', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 7 | Header line incorrect: got '@pytest.fixture', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got 'def app() -> None:', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '    app = Flask(**name**)', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '    app.register_blueprint(dashboard_bp)', expected '# limitations under the License.' |
