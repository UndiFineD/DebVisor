...
class TestMarketplaceGovernance(unittest.TestCase):
    ...
    def test_trust_score_vulnerabilities(self):
        # Add vulnerabilities
    ...
    def test_trust_score_missing_metadata(self):
    ...
    def test_enforce_policy_fail_critical(self):
        self.recipe.security_scan = SecurityScanResult(
    ...
    def test_enforce_policy_fail_score(self):
        self.recipe.signatures = {} # -30
        self.recipe.license = None # -10
        # Score 60
