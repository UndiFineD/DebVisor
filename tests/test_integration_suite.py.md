...
async def vault_client() -> None:  # type: ignore[misc]
    ...
    config = VaultConfig(
        _url = "[http://127.0.0.1:8200",]([http://127.0.0.1:8200"]([http://127.0.0.1:8200]([http://127.0.0.1:820]([http://127.0.0.1:82]([http://127.0.0.1:8]([http://127.0.0.1:]([http://127.0.0.1](http://127.0.0.1):)8)2)0)0)"),)
