# Planning Report: tests\test_ssh_hardening.py

Generated: 2025-12-13T18:59:41.038950
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got 'from opt.services.security.ssh_hardening import SSHHardeningManager, SSHSecurityLevel', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 10 | Header line incorrect: got '    def test_basic_security_config(self) -> None:', expected '# limitations under the License.' |
...
File: tests\test_ssh_hardening.py
Current Description:
