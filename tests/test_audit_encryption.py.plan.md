# Planning Report: tests\test_audit_encryption.py

Generated: 2025-12-13T18:59:40.935489
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Unit tests for Audit Log Encryption.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- Field-level encryption/decryption', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- Key rotation', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Encrypted field serialization', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- Searchable encryption hashing', expected '# See the License for the specific language governing permissions and' |
...
File: tests\test_audit_encryption.py
Current Description:
