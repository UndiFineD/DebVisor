# Planning Report: tests\test_compliance.py

Generated: 2025-12-13T18:59:40.948317
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'from opt.services.compliance.core import ComplianceEngine, CompliancePolicy', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '@pytest.fixture', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got 'def engine() -> None:', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '    return ComplianceEngine()  # type: ignore[return-value]', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
