# Planning Report: tests\test_hvctl_xen.py

Generated: 2025-12-13T18:59:40.980256
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got 'Tests for Hypervisor CLI Xen Support.', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 6 | Header line incorrect: got 'from unittest.mock import patch, MagicMock', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got 'from opt.hvctl_enhanced import HypervisorCLI', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
...
| incorrect_header | 10 | Header line incorrect: got '@patch("subprocess.run")', expected '# limitations under the License.' |
