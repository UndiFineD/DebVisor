# Planning Report: tests\test_security_testing.py

Generated: 2025-12-13T18:59:41.034322
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Unit tests for security testing framework.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- OWASP Top 10 checks', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- Dependency vulnerability scanning', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Container security scanning', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- Security report generation', expected '# See the License for the specific language governing permissions and' |
...
File: tests\test_security_testing.py
Current Description:
