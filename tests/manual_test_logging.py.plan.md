# Planning Report: tests\manual_test_logging.py

Generated: 2025-12-13T18:59:40.911353
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 1 | Header line incorrect: got 'import logging', expected '# Copyright (c) 2025 DebVisor contributors' |
| incorrect_header | 2 | Header line incorrect: got 'import structlog', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
| incorrect_header | 3 | Header line incorrect: got 'import sys', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'import os', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 6 | Header line incorrect: got '# Add workspace root to path', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got 'sys.path.append(os.getcwd())', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
...
| incorrect_header | 9 | Header line incorrect: got 'from opt.core.logging import configure_logging    # noqa: E402', expected '# See the License for the specific language governing permissions and' |
...
File: tests\manual_test_logging.py
Current Description:
