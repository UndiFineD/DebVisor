# Planning Report: tests\test_netcfg_tui_full.py

Generated: 2025-12-13T18:59:41.001421
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Comprehensive tests for netcfg-tui network configuration system.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- IP address configuration', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- Interface management', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Bond configuration', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- VLAN configuration', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '- Bridge configuration', expected '# limitations under the License.' |
...
File: tests\test_netcfg_tui_full.py
Current Description:
