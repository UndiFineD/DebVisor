...
from opt.services.audit_encryption import (
    FieldEncryptor, EncryptionAlgorithm, KeyStatus,
    EncryptedField, EncryptionKey
)
...
class TestFieldEncryptor(unittest.TestCase):
    ...
    def test_encrypt_decrypt(self, mock_aesgcm_cls):
        ...
        mock_aesgcm.encrypt.return_value = b"encrypted_data" + b"tag_bytes_______" # 16 bytes tag
