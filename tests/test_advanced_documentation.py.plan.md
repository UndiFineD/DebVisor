# Planning Report: tests\test_advanced_documentation.py

Generated: 2025-12-13T18:59:40.915903
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Tests for advanced documentation system.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- Architecture Decision Records', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- Operational playbooks', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Security procedures', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- Troubleshooting guides', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '- Performance tuning guides', expected '# limitations under the License.' |
...
File: tests\test_advanced_documentation.py
Current Description:
