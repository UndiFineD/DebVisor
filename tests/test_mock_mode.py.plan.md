# Planning Report: tests\test_mock_mode.py

Generated: 2025-12-13T18:59:40.991925
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Test suite for DebVisor Mock Mode Infrastructure.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got 'import json', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got 'import os', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got 'import tempfile', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got 'import time', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got 'import unittest', expected '# limitations under the License.' |
