# Planning Report: tests\test_audit_chain.py

Generated: 2025-12-13T18:59:40.933233
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 1 | Header line incorrect: got 'from unittest.mock import MagicMock, patch', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 9 | Header line incorrect: got 'class TestAuditChain(unittest.TestCase):', expected '# See the License for the specific language governing permissions and' |
