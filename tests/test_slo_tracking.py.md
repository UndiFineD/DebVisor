...
| 172 | 0 | bandit | `B101` | LOW | Use of assert detected. The enclosed code will be removed when compiling to optimised byte code. |
...
| 291 | 0 | bandit | `B101` | LOW | Use of assert detected. The enclosed code will be removed when compiling to optimised byte code. |
...
| 381 | 0 | bandit | `B101` | LOW | Use of assert detected. The enclosed code will be removed when compiling to optimised byte code. |
...
```python
        ...
        assert abs(budget.total_budget - 0.01)  None:
```python
...
```python
        ...
        # Availability is 98%  200ms target, so should fail
        assert latency_compliance is False
