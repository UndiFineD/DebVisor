# Planning Report: tests\test_compliance_reporting.py

Generated: 2025-12-13T18:59:40.951766
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 1 | Header line incorrect: got 'from unittest.mock import patch, MagicMock', expected '# Copyright (c) 2025 DebVisor contributors' |
| incorrect_header | 2 | Header line incorrect: got 'import unittest', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
| incorrect_header | 3 | Header line incorrect: got 'from opt.services.compliance.reporting import ComplianceReporter', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'from opt.services.compliance.core import ComplianceReport, ComplianceViolation', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 7 | Header line incorrect: got 'import pytest', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got 'from datetime import datetime', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got 'class TestComplianceReporting(unittest.TestCase):', expected '# See the License for the specific language governing permissions and' |
...
File: tests\test_compliance_reporting.py
Current Description:
