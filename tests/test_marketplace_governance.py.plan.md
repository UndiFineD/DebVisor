# Planning Report: tests\test_marketplace_governance.py

Generated: 2025-12-13T18:59:40.986245
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'from datetime import datetime', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'from opt.services.marketplace.marketplace_service import (', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 6 | Header line incorrect: got '    SecurityScanner, Recipe, SecurityScanResult', expected '# Unless required by applicable law or agreed to in writing, software' |
...
| incorrect_header | 10 | Header line incorrect: got 'class TestMarketplaceGovernance(unittest.TestCase):', expected '# limitations under the License.' |
...
File: tests\test_marketplace_governance.py
Current Description:
