# Planning Report: tests\test_oidc_oauth2.py

Generated: 2025-12-13T18:59:41.006572
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Unit tests for OIDC/OAuth2 authentication.', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 6 | Header line incorrect: got '- JWT token management', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- OIDC provider flows', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- Role-based access control', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- Session management', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '- Authentication workflows', expected '# limitations under the License.' |
