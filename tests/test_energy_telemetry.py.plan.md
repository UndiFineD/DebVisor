# Planning Report: tests\test_energy_telemetry.py

Generated: 2025-12-13T18:59:40.969168
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got 'Tests for Energy Telemetry.', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 6 | Header line incorrect: got 'from unittest.mock import patch, mock_open', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got 'from opt.services.observability.energy import EnergyMonitor', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '@pytest.fixture', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got 'def monitor() -> EnergyMonitor:', expected '# See the License for the specific language governing permissions and' |
...
File: tests\test_energy_telemetry.py
Current Description:
