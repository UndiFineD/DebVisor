# Planning Report: tests\test_acme_certificates.py

Generated: 2025-12-13T18:59:40.913608
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 1 | Header line incorrect: got 'from unittest.mock import patch', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 3 | Header line incorrect: got '# from unittest.mock import patch', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'from opt.services.security.acme_certificates import ACMECertificateManager, ACMEConfig, CertificateStatus', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 10 | Header line incorrect: got 'def acme_manager() -> None:', expected '# limitations under the License.' |
...
File: tests\test_acme_certificates.py
Current Description:
