# Planning Report: fix_blocklists_md.py

Generated: 2025-12-13T18:59:40.244154
Status: INVALID
...
| incorrect_header | 4 | Header line incorrect: got 'file_path = 'etc/debvisor/test_validate_blocklists.py.plan.md'', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 10 | Header line incorrect: got '# Fix MD034: Wrap bare URLs in markdown links', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 11 | Header line incorrect: got '# Match URLs that aren't already wrapped in [](https://)', expected '# limitations under the License.' |
