...
Generated: 2025-12-13T17:06:28.245296
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Comprehensive markdown linting fixer for all documents.', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'Fixes common markdown issues like:', expected '# You may obtain a copy of the License at' |
| incorrect_header | 5 | Header line incorrect: got '- MD001: Multiple top-level headings', expected '#     [http://www.apache.org/licenses/LICENSE-2.0']([http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0)') |
| incorrect_header | 6 | Header line incorrect: got '- MD003: Consistent heading style', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '- MD004: Consistent list marker style (dashes)', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '- MD005: Consistent list indentation', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '- MD006: Start of unordered list not at beginning', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '- MD007: Unordered list indentation (2 spaces)', expected '# limitations under the License.' |
