...
|----|------|----------|------|------|---------|
| 7897 | F821 | warning | `tests/test_hvctl_xen.py` | 29 | undefined name 'MagicMock' |
| 7896 | F821 | warning | `tests/test_hvctl_xen.py` | 27 | undefined name 'HypervisorCLI' |
| 7895 | F821 | warning | `tests/test_hvctl_xen.py` | 13 | undefined name 'MagicMock' |
| 7894 | F821 | warning | `tests/test_hvctl_xen.py` | 10 | undefined name 'HypervisorCLI' |
| 7892 | F821 | warning | `tests/test_dns_hosting.py` | 88 | undefined name 'DNSRecordType' |
| 7891 | F821 | warning | `tests/test_dns_hosting.py` | 88 | undefined name 'DNSRecord' |
| 7890 | F821 | warning | `tests/test_dns_hosting.py` | 74 | undefined name 'DNSRecordType' |
| 7889 | F821 | warning | `tests/test_dns_hosting.py` | 74 | undefined name 'DNSRecord' |
| 7888 | F821 | warning | `tests/test_dns_hosting.py` | 73 | undefined name 'DNSRecordType' |
| 7887 | F821 | warning | `tests/test_dns_hosting.py` | 73 | undefined name 'DNSRecord' |
| 7886 | F821 | warning | `tests/test_dns_hosting.py` | 61 | undefined name 'DNSRecordType' |
| 7885 | F821 | warning | `tests/test_dns_hosting.py` | 61 | undefined name 'DNSRecord' |
| 7884 | F821 | warning | `tests/test_dns_hosting.py` | 54 | undefined name 'DNSRecordType' |
| 7883 | F821 | warning | `tests/test_dns_hosting.py` | 50 | undefined name 'DNSRecordType' |
| 7882 | F821 | warning | `tests/test_dns_hosting.py` | 50 | undefined name 'DNSRecord' |
| 7881 | F821 | warning | `tests/test_dns_hosting.py` | 43 | undefined name 'DNSRecordType' |
| 7880 | F821 | warning | `tests/test_dns_hosting.py` | 43 | undefined name 'DNSRecord' |
| 7879 | F821 | warning | `tests/test_dns_hosting.py` | 33 | undefined name 'DNSRecordType' |
| 7878 | F821 | warning | `tests/test_dns_hosting.py` | 33 | undefined name 'DNSRecord' |
| 7875 | F821 | warning | `tests/test_backup_manager_encryption.py` | 37 | undefined name 'AESGCM' |
| 7868 | F821 | warning | `tests/test_acme_certificates.py` | 47 | undefined name 'patch' |
| 7867 | F821 | warning | `tests/test_acme_certificates.py` | 43 | undefined name 'patch' |
| 7866 | F821 | warning | `tests/test_acme_certificates.py` | 34 | undefined name 'CertificateStatus' |
...
| 7824 | F821 | warning | `opt/services/cache.py` | 528 | undefined name 'Any' |
| 7823 | F821 | warning | `opt/services/cache.py` | 528 | undefined name 'Any' |
| 7822 | F821 | warning | `opt/services/cache.py` | 528 | undefined name 'Any' |
| 7821 | F821 | warning | `opt/services/cache.py` | 523 | undefined name 'Callable' |
| 7820 | F821 | warning | `opt/services/cache.py` | 522 | undefined name 'Set' |
| 7819 | F821 | warning | `opt/services/cache.py` | 522 | undefined name 'Optional' |
| 7818 | F821 | warning | `opt/services/cache.py` | 521 | undefined name 'Optional' |
| 7817 | F821 | warning | `opt/services/cache.py` | 491 | undefined name 'Set' |
| 7816 | F821 | warning | `opt/services/cache.py` | 461 | undefined name 'Any' |
| 7815 | F821 | warning | `opt/services/cache.py` | 436 | undefined name 'Any' |
| 7814 | F821 | warning | `opt/services/cache.py` | 436 | undefined name 'Optional' |
| 7813 | F821 | warning | `opt/services/cache.py` | 391 | undefined name 'Set' |
| 7812 | F821 | warning | `opt/services/cache.py` | 337 | undefined name 'Any' |
| 7811 | F821 | warning | `opt/services/cache.py` | 309 | undefined name 'Any' |
| 7810 | F821 | warning | `opt/services/cache.py` | 309 | undefined name 'Optional' |
| 7809 | F821 | warning | `opt/services/cache.py` | 285 | undefined name 'Optional' |
| 7808 | F821 | warning | `opt/services/cache.py` | 259 | undefined name 'Set' |
| 7807 | F821 | warning | `opt/services/cache.py` | 214 | undefined name 'Any' |
| 7806 | F821 | warning | `opt/services/cache.py` | 185 | undefined name 'Any' |
| 7805 | F821 | warning | `opt/services/cache.py` | 185 | undefined name 'Optional' |
| 7804 | F821 | warning | `opt/services/cache.py` | 180 | undefined name 'Dict' |
| 7803 | F821 | warning | `opt/services/cache.py` | 161 | undefined name 'Set' |
| 7802 | F821 | warning | `opt/services/cache.py` | 146 | undefined name 'Any' |
| 7801 | F821 | warning | `opt/services/cache.py` | 141 | undefined name 'Any' |
| 7800 | F821 | warning | `opt/services/cache.py` | 141 | undefined name 'Optional' |
| 7799 | F821 | warning | `opt/services/cache.py` | 112 | undefined name 'Set' |
| 7798 | F821 | warning | `opt/services/cache.py` | 106 | undefined name 'Any' |
| 7797 | F821 | warning | `opt/services/cache.py` | 96 | undefined name 'Any' |
| 7796 | F821 | warning | `opt/services/cache.py` | 96 | undefined name 'Dict' |
| 7795 | F821 | warning | `opt/services/cache.py` | 54 | undefined name 'logging' |
| 7794 | F821 | warning | `opt/services/cache.py` | 49 | undefined name 'Any' |
...
| 7568 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 23 | score is 0: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/type-check.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 7567 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 26 | score is 0: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/type-check.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 7566 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 23 | score is 0: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/type-check.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 7565 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 593 | score is 0: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/release.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 7280 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 824 | Stack trace information flows to this location and may be exposed to an external user. |
| 7279 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 812 | Stack trace information flows to this location and may be exposed to an external user. |
| 7278 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 791 | Stack trace information flows to this location and may be exposed to an external user. |
| 7277 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 763 | Stack trace information flows to this location and may be exposed to an external user. |
| 7276 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 747 | Stack trace information flows to this location and may be exposed to an external user. |
| 7275 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 603 | Stack trace information flows to this location and may be exposed to an external user. |
| 7274 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 603 | Stack trace information flows to this location and may be exposed to an external user. |
| 7273 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 542 | Stack trace information flows to this location and may be exposed to an external user. |
| 7272 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 542 | Stack trace information flows to this location and may be exposed to an external user. |
| 7271 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 573 | Stack trace information flows to this location and may be exposed to an external user. |
| 7270 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 568 | Stack trace information flows to this location and may be exposed to an external user. |
| 7269 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 529 | Stack trace information flows to this location and may be exposed to an external user. Stack trace information flows to this location and may be exposed to an external user. |
| 7268 | py/stack-trace-exposure | error | `opt/services/compliance/api.py` | 65 | Stack trace information flows to this location and may be exposed to an external user. |
| 7267 | py/stack-trace-exposure | error | `opt/services/compliance/api.py` | 63 | Stack trace information flows to this location and may be exposed to an external user. |
| 7266 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 812 | Cross-site scripting vulnerability due to a user-provided value. |
| 7265 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 791 | Cross-site scripting vulnerability due to a user-provided value. |
| 7264 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 763 | Cross-site scripting vulnerability due to a user-provided value. |
| 7263 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 747 | Cross-site scripting vulnerability due to a user-provided value. |
| 7262 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 568 | Cross-site scripting vulnerability due to a user-provided value. |
| 7261 | py/incomplete-url-substring-sanitization | warning | `tests/test_acme_certificates.py` | 57 | The string example.com may be at an arbitrary position in the sanitized URL. |
...
| 7147 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 600 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 7146 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 599 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
...
| 7128 | py/clear-text-logging-sensitive-data | error | `opt/services/secrets/vault_manager.py` | 658 | This expression logs sensitive data (secret) as clear text. This expression logs sensitive data (secret) as clear text. |
| 7127 | py/clear-text-logging-sensitive-data | error | `opt/services/secrets_management.py` | 637 | This expression logs sensitive data (password) as clear text. |
...
| 7077 | py/url-redirection | error | `opt/web/panel/app.py` | 498 | Untrusted URL redirection depends on a user-provided value. |
...
| 7075 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 35 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 7074 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 34 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 7073 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 33 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 7072 | PinnedDependenciesID | error | `.github/workflows/type-check.yml` | 32 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
...
| 6950 | PinnedDependenciesID | error | `.github/workflows/fuzzing.yml` | 30 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6949 | PinnedDependenciesID | error | `.github/workflows/fuzzing.yml` | 29 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6948 | PinnedDependenciesID | error | `.github/workflows/fuzzing.yml` | 28 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
...
| 6925 | py/url-redirection | error | `opt/web/panel/routes/auth.py` | 140 | Untrusted URL redirection depends on a user-provided value. |
...
| 6346 | PinnedDependenciesID | error | `.github/workflows/scorecard.yml` | 63 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/scorecard.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 6196 | CodeReviewID | error | `no file associated with this alert` | 1 | score is 0: Found 0/24 approved changesets -- score normalized to 0 Click Remediation section below to solve this issue |
...
| 6146 | PinnedDependenciesID | error | `.github/workflows/validate-syntax.yml` | 194 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6145 | PinnedDependenciesID | error | `.github/workflows/validate-syntax.yml` | 192 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6144 | PinnedDependenciesID | error | `.github/workflows/validate-grafana.yml` | 37 | score is 4: npmCommand not pinned by hash Click Remediation section below to solve this issue |
...
| 6142 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 103 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6141 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 102 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6140 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 44 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6139 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 36 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6138 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 32 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6137 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 31 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6136 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 30 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6135 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 128 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6134 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 127 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6133 | PinnedDependenciesID | error | `.github/workflows/test.yml` | 126 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6132 | PinnedDependenciesID | error | `.github/workflows/security.yml` | 192 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6131 | PinnedDependenciesID | error | `.github/workflows/security.yml` | 192 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6130 | PinnedDependenciesID | error | `.github/workflows/security.yml` | 165 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6129 | PinnedDependenciesID | error | `.github/workflows/security.yml` | 75 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6128 | PinnedDependenciesID | error | `.github/workflows/security.yml` | 42 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6127 | PinnedDependenciesID | error | `.github/workflows/sbom.yml` | 26 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6126 | PinnedDependenciesID | error | `.github/workflows/sbom.yml` | 23 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6125 | PinnedDependenciesID | error | `.github/workflows/sbom.yml` | 23 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6124 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 36 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6123 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 35 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6122 | PinnedDependenciesID | error | `.github/workflows/performance.yml` | 32 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6121 | PinnedDependenciesID | error | `.github/workflows/mutation-testing.yml` | 23 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6120 | PinnedDependenciesID | error | `.github/workflows/mutation-testing.yml` | 22 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6119 | PinnedDependenciesID | error | `.github/workflows/mutation-testing.yml` | 21 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6118 | PinnedDependenciesID | error | `.github/workflows/markdown-lint.yml` | 38 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6117 | PinnedDependenciesID | error | `.github/workflows/markdown-lint.yml` | 37 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6116 | PinnedDependenciesID | error | `.github/workflows/manifest-validation.yml` | 54 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6115 | PinnedDependenciesID | error | `.github/workflows/manifest-validation.yml` | 363 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6114 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 129 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6113 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 111 | score is 4: npmCommand not pinned by hash Click Remediation section below to solve this issue |
| 6112 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 29 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6111 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 28 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6110 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 27 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6109 | PinnedDependenciesID | error | `.github/workflows/fuzz-testing.yml` | 22 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6108 | PinnedDependenciesID | error | `.github/workflows/fuzz-testing.yml` | 21 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6107 | PinnedDependenciesID | error | `.github/workflows/deploy.yml` | 33 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6106 | PinnedDependenciesID | error | `.github/workflows/deploy.yml` | 32 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6105 | PinnedDependenciesID | error | `.github/workflows/compliance.yml` | 23 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6104 | PinnedDependenciesID | error | `.github/workflows/compliance.yml` | 22 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6103 | PinnedDependenciesID | error | `.github/workflows/codeql.yml` | 48 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6102 | PinnedDependenciesID | error | `.github/workflows/codeql.yml` | 47 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6101 | PinnedDependenciesID | error | `.github/workflows/chaos-testing.yml` | 22 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6100 | PinnedDependenciesID | error | `.github/workflows/chaos-testing.yml` | 21 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6099 | PinnedDependenciesID | error | `.github/workflows/blocklist-integration-tests.yml` | 64 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6098 | PinnedDependenciesID | error | `.github/workflows/blocklist-integration-tests.yml` | 63 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6097 | PinnedDependenciesID | error | `.github/workflows/blocklist-integration-tests.yml` | 313 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6096 | PinnedDependenciesID | error | `.github/workflows/blocklist-integration-tests.yml` | 312 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6095 | PinnedDependenciesID | error | `.github/workflows/architecture.yml` | 24 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6094 | PinnedDependenciesID | error | `.github/workflows/architecture.yml` | 24 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6093 | PinnedDependenciesID | error | `.github/workflows/architecture.yml` | 22 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6092 | PinnedDependenciesID | error | `.github/workflows/ansible-syntax-check.yml` | 39 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6091 | PinnedDependenciesID | error | `.github/workflows/ansible-syntax-check.yml` | 38 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6090 | PinnedDependenciesID | error | `.github/workflows/ansible-syntax-check.yml` | 37 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6089 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 500 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6088 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 499 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6087 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 421 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6086 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 420 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6085 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 41 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6084 | PinnedDependenciesID | error | `.github/workflows/ansible-inventory-validation.yml` | 40 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
...
| 6082 | PinnedDependenciesID | error | `opt/monitoring/fixtures/generator/Dockerfile` | 12 | score is 4: pipCommand not pinned by hash Click Remediation section below to solve this issue |
| 6081 | PinnedDependenciesID | error | `opt/monitoring/fixtures/generator/Dockerfile` | 2 | score is 4: containerImage not pinned by hash Remediation tip: pin your Docker image by updating python:3.11-slim to python:3.11-slim@sha256:7cd0079a9bd8800c81632d65251048fc2848bf9afda542224b1b10e0cae45575 Click Remediation section below for further remediation help |
...
| 6025 | PinnedDependenciesID | error | `.github/workflows/secret-scan.yml` | 63 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/secret-scan.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 6000 | PinnedDependenciesID | error | `.github/workflows/release.yml` | 230 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/release.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 5965 | PinnedDependenciesID | error | `.github/workflows/manifest-validation.yml` | 242 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/manifest-validation.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 5960 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 67 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/lint.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 5959 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 59 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/lint.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 5958 | PinnedDependenciesID | error | `.github/workflows/lint.yml` | 21 | score is 0: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/lint.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 5923 | PinnedDependenciesID | error | `.github/workflows/codeql.yml` | 54 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/codeql.yml/main?enable=pin) Click Remediation section below for further remediation help |
| 5922 | PinnedDependenciesID | error | `.github/workflows/codeql.yml` | 51 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/codeql.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 5920 | PinnedDependenciesID | error | `.github/workflows/codeql.yml` | 34 | score is 4: GitHub-owned GitHubAction not pinned by hash Remediation tip: update your workflow using [https://app.stepsecurity.io](https://app.stepsecurity.io/secureworkflow/UndiFineD/DebVisor/codeql.yml/main?enable=pin) Click Remediation section below for further remediation help |
...
| 83 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 597 | Stack trace information flows to this location and may be exposed to an external user. |
| 82 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 597 | Stack trace information flows to this location and may be exposed to an external user. |
| 81 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 591 | Stack trace information flows to this location and may be exposed to an external user. |
| 80 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 591 | Stack trace information flows to this location and may be exposed to an external user. |
| 79 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 584 | Stack trace information flows to this location and may be exposed to an external user. |
| 78 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 584 | Stack trace information flows to this location and may be exposed to an external user. |
| 77 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 578 | Stack trace information flows to this location and may be exposed to an external user. |
| 76 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 578 | Stack trace information flows to this location and may be exposed to an external user. |
| 75 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 573 | Stack trace information flows to this location and may be exposed to an external user. |
| 74 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 573 | Stack trace information flows to this location and may be exposed to an external user. |
| 73 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 568 | Stack trace information flows to this location and may be exposed to an external user. |
| 72 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 568 | Stack trace information flows to this location and may be exposed to an external user. |
| 71 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 562 | Stack trace information flows to this location and may be exposed to an external user. |
| 70 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 562 | Stack trace information flows to this location and may be exposed to an external user. |
| 69 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 557 | Stack trace information flows to this location and may be exposed to an external user. |
| 68 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 557 | Stack trace information flows to this location and may be exposed to an external user. |
| 67 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 552 | Stack trace information flows to this location and may be exposed to an external user. |
| 66 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 552 | Stack trace information flows to this location and may be exposed to an external user. |
| 65 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 547 | Stack trace information flows to this location and may be exposed to an external user. |
| 64 | py/stack-trace-exposure | error | `opt/services/multiregion/api.py` | 547 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 60 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 816 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 58 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 804 | Stack trace information flows to this location and may be exposed to an external user. |
| 57 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 799 | Stack trace information flows to this location and may be exposed to an external user. |
| 56 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 795 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 54 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 783 | Stack trace information flows to this location and may be exposed to an external user. |
| 53 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 779 | Stack trace information flows to this location and may be exposed to an external user. |
| 52 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 771 | Stack trace information flows to this location and may be exposed to an external user. |
| 51 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 767 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 49 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 755 | Stack trace information flows to this location and may be exposed to an external user. |
| 48 | py/stack-trace-exposure | error | `opt/services/anomaly/api.py` | 751 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 44 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 563 | Stack trace information flows to this location and may be exposed to an external user. |
| 43 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 556 | Stack trace information flows to this location and may be exposed to an external user. |
| 42 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 551 | Stack trace information flows to this location and may be exposed to an external user. |
| 41 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 546 | Stack trace information flows to this location and may be exposed to an external user. Stack trace information flows to this location and may be exposed to an external user. |
| 40 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 541 | Stack trace information flows to this location and may be exposed to an external user. |
| 39 | py/stack-trace-exposure | error | `opt/services/scheduler/api.py` | 536 | Stack trace information flows to this location and may be exposed to an external user. |
...
| 37 | py/weak-sensitive-data-hashing | warning | `opt/services/rpc/auth.py` | 604 | Sensitive data (password) is used in a hashing algorithm (SHA256) that is insecure for password hashing, since it is not a computationally expensive hash function. |
...
| 34 | py/weak-sensitive-data-hashing | warning | `opt/services/api_key_manager.py` | 168 | Sensitive data (password) is used in a hashing algorithm (SHA256) that is insecure for password hashing, since it is not a computationally expensive hash function. Sensitive data (password) is used in a hashing algorithm (SHA256) that is insecure for password hashing, since it is not a computationally expensive hash function. Sensitive data (password) is used in a hashing algorithm (SHA256) that is insecure for password hashing, since it is not a computationally expensive hash function. Sensitive data (password) is used in a hashing algorithm (SHA256) that is insecure for password hashing, since it is not a computationally expensive hash function. |
...
| 32 | py/reflective-xss | error | `opt/services/multiregion/api.py` | 578 | Cross-site scripting vulnerability due to a user-provided value. |
| 31 | py/reflective-xss | error | `opt/services/multiregion/api.py` | 562 | Cross-site scripting vulnerability due to a user-provided value. |
| 30 | py/reflective-xss | error | `opt/services/multiregion/api.py` | 557 | Cross-site scripting vulnerability due to a user-provided value. |
| 29 | py/reflective-xss | error | `opt/services/multiregion/api.py` | 552 | Cross-site scripting vulnerability due to a user-provided value. |
...
| 27 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 804 | Cross-site scripting vulnerability due to a user-provided value. Cross-site scripting vulnerability due to a user-provided value. |
| 26 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 799 | Cross-site scripting vulnerability due to a user-provided value. |
...
| 24 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 779 | Cross-site scripting vulnerability due to a user-provided value. |
| 23 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 771 | Cross-site scripting vulnerability due to a user-provided value. Cross-site scripting vulnerability due to a user-provided value. |
...
| 21 | py/reflective-xss | error | `opt/services/anomaly/api.py` | 755 | Cross-site scripting vulnerability due to a user-provided value. Cross-site scripting vulnerability due to a user-provided value. |
...
| 18 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 563 | Cross-site scripting vulnerability due to a user-provided value. |
| 17 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 556 | Cross-site scripting vulnerability due to a user-provided value. |
| 16 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 551 | Cross-site scripting vulnerability due to a user-provided value. |
| 15 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 546 | Cross-site scripting vulnerability due to a user-provided value. |
| 14 | py/reflective-xss | error | `opt/services/scheduler/api.py` | 541 | Cross-site scripting vulnerability due to a user-provided value. |
...
| 11 | py/clear-text-storage-sensitive-data | error | `opt/tools/first_boot_keygen.py` | 122 | This expression stores sensitive data (secret) as clear text. |
| 10 | py/clear-text-logging-sensitive-data | error | `opt/system/hypervisor/xen_driver.py` | 994 | This expression logs sensitive data (password) as clear text. |
...
| 1 | py/clear-text-logging-sensitive-data | error | `opt/services/api_key_manager.py` | 465 | This expression logs sensitive data (password) as clear text. This expression logs sensitive data (password) as clear text. |

    ## Code Quality & Style Issues

| ID | Rule | File | Line | Message |
|----|------|------|------|---------|
| 7904 | E302 | `tests/test_ssh_hardening.py` | 5 | expected 2 blank lines, found 1 |
| 7903 | E116 | `tests/test_ssh_hardening.py` | 3 | unexpected indentation (comment) |
| 7902 | E302 | `tests/test_runbooks.py` | 8 | expected 2 blank lines, found 1 |
| 7901 | E116 | `tests/test_runbooks.py` | 6 | unexpected indentation (comment) |
| 7900 | E116 | `tests/test_migrations.py` | 6 | unexpected indentation (comment) |
| 7899 | E116 | `tests/test_migrations.py` | 4 | unexpected indentation (comment) |
| 7898 | E302 | `tests/test_marketplace_governance.py` | 6 | expected 2 blank lines, found 1 |
| 7893 | E116 | `tests/test_hvctl_xen.py` | 5 | unexpected indentation (comment) |
| 7877 | E302 | `tests/test_dns_hosting.py` | 8 | expected 2 blank lines, found 1 |
| 7876 | E116 | `tests/test_dns_hosting.py` | 6 | unexpected indentation (comment) |
| 7874 | E116 | `tests/test_backup_manager_encryption.py` | 5 | unexpected indentation (comment) |
| 7873 | E116 | `tests/test_audit_encryption.py` | 14 | unexpected indentation (comment) |
| 7872 | E302 | `tests/test_audit_chain.py` | 9 | expected 2 blank lines, found 1 |
| 7871 | E116 | `tests/test_audit_chain.py` | 7 | unexpected indentation (comment) |
| 7870 | E116 | `tests/test_audit_chain.py` | 6 | unexpected indentation (comment) |
| 7869 | E116 | `tests/test_audit_chain.py` | 5 | unexpected indentation (comment) |
| 7862 | E116 | `tests/test_acme_certificates.py` | 3 | unexpected indentation (comment) |
| 7861 | E116 | `scripts/license_header_check.py` | 21 | unexpected indentation (comment) |
| 7859 | E305 | `scripts/fix_whitespace.py` | 56 | expected 2 blank lines after class or function definition, found 1 |
| 7858 | W293 | `scripts/fix_security_scan.py` | 518 | blank line contains whitespace |
| 7857 | W293 | `scripts/fix_security_scan.py` | 508 | blank line contains whitespace |
| 7856 | W293 | `scripts/fix_security_scan.py` | 366 | blank line contains whitespace |
| 7854 | W293 | `scripts/fix_security_scan.py` | 335 | blank line contains whitespace |
| 7853 | E302 | `scripts/auto_fix_mypy.py` | 25 | expected 2 blank lines, found 1 |
| 7847 | E116 | `opt/web/panel/routes/auth.py` | 22 | unexpected indentation (comment) |
| 7846 | E116 | `opt/services/rpc/tests/test_rpc_features.py` | 14 | unexpected indentation (comment) |
| 7845 | E116 | `opt/services/network/multitenant_network.py` | 30 | unexpected indentation (comment) |
| 7843 | E116 | `opt/services/multiregion/replication_scheduler.py` | 31 | unexpected indentation (comment) |
| 7842 | E116 | `opt/services/multiregion/core.py` | 30 | unexpected indentation (comment) |
| 7841 | E116 | `opt/services/multiregion/core.py` | 25 | unexpected indentation (comment) |
| 7840 | E116 | `opt/services/multiregion/cli.py` | 23 | unexpected indentation (comment) |
| 7839 | E116 | `opt/services/migration/advanced_migration.py` | 28 | unexpected indentation (comment) |
| 7838 | E116 | `opt/services/marketplace/marketplace_service.py` | 36 | unexpected indentation (comment) |
| 7837 | E116 | `opt/services/marketplace/marketplace_service.py` | 35 | unexpected indentation (comment) |
| 7836 | E116 | `opt/services/licensing/licensing_server.py` | 38 | unexpected indentation (comment) |
| 7835 | E116 | `opt/services/licensing/licensing_server.py` | 35 | unexpected indentation (comment) |
| 7834 | E116 | `opt/services/fleet/federation_manager.py` | 28 | unexpected indentation (comment) |
| 7833 | E116 | `opt/services/fleet/federation_manager.py` | 27 | unexpected indentation (comment) |
| 7831 | E116 | `opt/services/containers/container_integration.py` | 25 | unexpected indentation (comment) |
| 7830 | E116 | `opt/services/containers/container_integration.py` | 24 | unexpected indentation (comment) |
| 7829 | E116 | `opt/services/cluster/large_cluster_optimizer.py` | 26 | unexpected indentation (comment) |
| 7828 | E116 | `opt/services/cluster/large_cluster_optimizer.py` | 25 | unexpected indentation (comment) |
| 7792 | E116 | `opt/services/cache.py` | 36 | unexpected indentation (comment) |
| 7791 | E116 | `opt/services/billing/billing_integration.py` | 34 | unexpected indentation (comment) |
| 7790 | E116 | `opt/services/backup/dedup_backup_service.py` | 31 | unexpected indentation (comment) |
| 7789 | E116 | `opt/services/backup/dedup_backup_service.py` | 27 | unexpected indentation (comment) |
| 7788 | E116 | `opt/netcfg-tui/tests/test_netcfg.py` | 14 | unexpected indentation (comment) |
| 7787 | E116 | `opt/dvctl.py` | 22 | unexpected indentation (comment) |
| 7786 | E116 | `opt/dvctl.py` | 21 | unexpected indentation (comment) |
| 7785 | E116 | `opt/dvctl.py` | 20 | unexpected indentation (comment) |
| 7782 | E402 | `tests/test_integration_suite.py` | 32 | module level import not at top of file |
| 7781 | E402 | `tests/test_integration_suite.py` | 26 | module level import not at top of file |
| 7780 | E402 | `tests/test_integration_suite.py` | 25 | module level import not at top of file |
| 7779 | E305 | `scripts/fix_whitespace.py` | 45 | expected 2 blank lines after class or function definition, found 1 |
| 7778 | E302 | `scripts/fix_whitespace.py` | 36 | expected 2 blank lines, found 1 |
| 7777 | E302 | `scripts/fix_whitespace.py` | 30 | expected 2 blank lines, found 1 |
| 7776 | E302 | `scripts/fix_whitespace.py` | 24 | expected 2 blank lines, found 1 |
| 7775 | E302 | `scripts/fix_whitespace.py` | 16 | expected 2 blank lines, found 1 |
| 7774 | E501 | `scripts/auto_fix_mypy.py` | 122 | line too long (139 > 120 characters) |
| 7772 | E301 | `opt/system/upgrade_manager.py` | 84 | expected 1 blank line, found 0 |
| 7770 | W391 | `opt/services/__init__.py` | 11 | blank line at end of file |
| 7769 | W391 | `opt/__init__.py` | 11 | blank line at end of file |
| 7767 | W293 | `tests/test_slo_tracking.py` | 369 | blank line contains whitespace |
| 7766 | E302 | `tests/test_cost_optimization.py` | 9 | expected 2 blank lines, found 1 |
| 7765 | W293 | `scripts/quick_fix_mypy.py` | 137 | blank line contains whitespace |
| 7764 | E741 | `scripts/quick_fix_mypy.py` | 134 | ambiguous variable name 'l' |
| 7763 | W293 | `scripts/quick_fix_mypy.py` | 132 | blank line contains whitespace |
| 7762 | W293 | `scripts/quick_fix_mypy.py` | 124 | blank line contains whitespace |
| 7761 | W293 | `scripts/quick_fix_mypy.py` | 121 | blank line contains whitespace |
| 7760 | W293 | `scripts/quick_fix_mypy.py` | 110 | blank line contains whitespace |
| 7759 | W293 | `scripts/quick_fix_mypy.py` | 103 | blank line contains whitespace |
| 7758 | W293 | `scripts/quick_fix_mypy.py` | 79 | blank line contains whitespace |
| 7757 | W293 | `scripts/quick_fix_mypy.py` | 75 | blank line contains whitespace |
| 7756 | W293 | `scripts/quick_fix_mypy.py` | 72 | blank line contains whitespace |
| 7755 | W293 | `scripts/quick_fix_mypy.py` | 57 | blank line contains whitespace |
| 7754 | W293 | `scripts/quick_fix_mypy.py` | 54 | blank line contains whitespace |
| 7753 | W293 | `scripts/quick_fix_mypy.py` | 51 | blank line contains whitespace |
| 7752 | E302 | `scripts/quick_fix_mypy.py` | 42 | expected 2 blank lines, found 1 |
| 7751 | W293 | `scripts/quick_fix_mypy.py` | 39 | blank line contains whitespace |
| 7750 | E741 | `scripts/auto_fix_mypy.py` | 124 | ambiguous variable name 'l' |
| 7749 | E741 | `scripts/auto_fix_mypy.py` | 121 | ambiguous variable name 'l' |
| 7748 | W293 | `scripts/auto_fix_mypy.py` | 73 | blank line contains whitespace |
| 7747 | W293 | `opt/webhook_system.py` | 404 | blank line contains whitespace |
| 7746 | E301 | `opt/webhook_system.py` | 336 | expected 1 blank line, found 0 |
| 7745 | E302 | `opt/web/dashboard/app.py` | 23 | expected 2 blank lines, found 1 |
| 7744 | E301 | `opt/testing/test_e2e_comprehensive.py` | 78 | expected 1 blank line, found 0 |
| 7743 | E999 | `opt/system/upgrade_manager.py` | 84 | SyntaxError: invalid syntax |
| 7742 | E302 | `opt/services/sdn/sdn_controller.py` | 113 | expected 2 blank lines, found 1 |
| 7740 | W293 | `opt/services/migration/import_wizard.py` | 678 | blank line contains whitespace |
| 7739 | W293 | `opt/services/migration/import_wizard.py` | 633 | blank line contains whitespace |
| 7738 | E131 | `opt/cert_manager.py` | 193 | continuation line unaligned for hanging indent |
| 7737 | E131 | `opt/cert_manager.py` | 189 | continuation line unaligned for hanging indent |
| 7736 | W292 | `tests/test_slo_tracking.py` | 470 | no newline at end of file |
| 7735 | W292 | `tests/test_security_testing.py` | 434 | no newline at end of file |
| 7734 | W292 | `tests/test_scheduler.py` | 575 | no newline at end of file |
| 7733 | W292 | `tests/test_runbooks.py` | 63 | no newline at end of file |
| 7732 | W292 | `tests/test_rpc_security.py` | 733 | no newline at end of file |
| 7731 | W292 | `tests/test_resilience.py` | 444 | no newline at end of file |
| 7730 | W292 | `tests/test_phase6_vnc.py` | 809 | no newline at end of file |
| 7729 | W292 | `tests/test_phase6_vm.py` | 758 | no newline at end of file |
| 7728 | W292 | `tests/test_phase6_dns.py` | 548 | no newline at end of file |
| 7727 | W292 | `tests/test_phase6_cloudinit.py` | 452 | no newline at end of file |
| 7726 | W292 | `tests/test_performance_testing.py` | 421 | no newline at end of file |
| 7725 | W292 | `tests/test_network_backends.py` | 703 | no newline at end of file |
| 7724 | W292 | `tests/test_netcfg_mock.py` | 636 | no newline at end of file |
| 7723 | W292 | `tests/test_multiregion.py` | 565 | no newline at end of file |
| 7722 | W292 | `tests/test_multi_cluster.py` | 386 | no newline at end of file |
| 7721 | W292 | `tests/test_monitoring.py` | 642 | no newline at end of file |
| 7720 | W292 | `tests/test_mock_mode.py` | 680 | no newline at end of file |
| 7719 | W292 | `tests/test_marketplace_governance.py` | 83 | no newline at end of file |
| 7718 | W292 | `tests/test_integration_suite.py` | 633 | no newline at end of file |
| 7717 | W292 | `tests/test_health_detail.py` | 83 | no newline at end of file |
| 7716 | W292 | `tests/test_health_blueprint.py` | 67 | no newline at end of file |
| 7715 | W292 | `tests/test_energy_telemetry.py` | 45 | no newline at end of file |
| 7714 | W292 | `tests/test_dns_hosting.py` | 89 | no newline at end of file |
| 7713 | W292 | `tests/test_distributed_tracing.py` | 452 | no newline at end of file |
| 7712 | W292 | `tests/test_dashboard.py` | 39 | no newline at end of file |
| 7711 | W292 | `tests/test_cost_optimization.py` | 75 | no newline at end of file |
| 7710 | W292 | `tests/test_contracts.py` | 745 | no newline at end of file |
| 7709 | W292 | `tests/test_compliance_remediation.py` | 69 | no newline at end of file |
| 7708 | W292 | `tests/test_compliance.py` | 63 | no newline at end of file |
| 7707 | W292 | `tests/test_chaos_engineering.py` | 757 | no newline at end of file |
| 7706 | W292 | `tests/test_backup_manager_encryption.py` | 104 | no newline at end of file |
| 7705 | W292 | `tests/test_audit_encryption.py` | 120 | no newline at end of file |
| 7704 | W292 | `tests/test_api_versioning.py` | 549 | no newline at end of file |
| 7703 | W292 | `tests/test_api_key_manager.py` | 401 | no newline at end of file |
| 7702 | W292 | `tests/test_anomaly.py` | 714 | no newline at end of file |
| 7701 | W292 | `tests/test_advanced_features.py` | 544 | no newline at end of file |
| 7700 | W292 | `tests/test_acme_certificates.py` | 57 | no newline at end of file |
| 7699 | W292 | `tests/benchmarks/test_performance.py` | 845 | no newline at end of file |
| 7698 | E305 | `scripts/update_type_ignore.py` | 119 | expected 2 blank lines after class or function definition, found 1 |
| 7697 | W293 | `scripts/update_type_ignore.py` | 113 | blank line contains whitespace |
| 7696 | E741 | `scripts/update_type_ignore.py` | 111 | ambiguous variable name 'l' |
| 7695 | W293 | `scripts/update_type_ignore.py` | 110 | blank line contains whitespace |
| 7694 | W293 | `scripts/update_type_ignore.py` | 102 | blank line contains whitespace |
| 7693 | W293 | `scripts/update_type_ignore.py` | 99 | blank line contains whitespace |
| 7692 | W293 | `scripts/update_type_ignore.py` | 96 | blank line contains whitespace |
| 7691 | W293 | `scripts/update_type_ignore.py` | 82 | blank line contains whitespace |
| 7690 | W293 | `scripts/update_type_ignore.py` | 78 | blank line contains whitespace |
| 7689 | W293 | `scripts/update_type_ignore.py` | 75 | blank line contains whitespace |
| 7688 | W293 | `scripts/update_type_ignore.py` | 71 | blank line contains whitespace |
| 7687 | W293 | `scripts/update_type_ignore.py` | 63 | blank line contains whitespace |
| 7686 | W293 | `scripts/update_type_ignore.py` | 60 | blank line contains whitespace |
| 7685 | W293 | `scripts/update_type_ignore.py` | 57 | blank line contains whitespace |
| 7684 | W293 | `scripts/update_type_ignore.py` | 54 | blank line contains whitespace |
| 7683 | W293 | `scripts/update_type_ignore.py` | 49 | blank line contains whitespace |
| 7682 | W293 | `scripts/update_type_ignore.py` | 47 | blank line contains whitespace |
| 7681 | W293 | `scripts/update_type_ignore.py` | 45 | blank line contains whitespace |
| 7680 | W293 | `scripts/update_type_ignore.py` | 37 | blank line contains whitespace |
| 7679 | W293 | `scripts/update_type_ignore.py` | 31 | blank line contains whitespace |
| 7678 | W293 | `scripts/update_type_ignore.py` | 28 | blank line contains whitespace |
| 7677 | W293 | `scripts/update_type_ignore.py` | 23 | blank line contains whitespace |
| 7676 | E302 | `scripts/update_type_ignore.py` | 21 | expected 2 blank lines, found 1 |
| 7675 | E305 | `scripts/quick_fix_mypy.py` | 145 | expected 2 blank lines after class or function definition, found 1 |
| 7674 | W293 | `scripts/quick_fix_mypy.py` | 105 | blank line contains whitespace |
| 7673 | E741 | `scripts/quick_fix_mypy.py` | 103 | ambiguous variable name 'l' |
| 7672 | W293 | `scripts/quick_fix_mypy.py` | 101 | blank line contains whitespace |
| 7671 | W293 | `scripts/quick_fix_mypy.py` | 93 | blank line contains whitespace |
| 7670 | W293 | `scripts/quick_fix_mypy.py` | 90 | blank line contains whitespace |
| 7669 | W293 | `scripts/quick_fix_mypy.py` | 117 | blank line contains whitespace |
| 7668 | W293 | `scripts/quick_fix_mypy.py` | 79 | blank line contains whitespace |
| 7667 | W293 | `scripts/quick_fix_mypy.py` | 73 | blank line contains whitespace |
| 7666 | W293 | `scripts/quick_fix_mypy.py` | 99 | blank line contains whitespace |
| 7665 | W293 | `scripts/quick_fix_mypy.py` | 96 | blank line contains whitespace |
| 7664 | W293 | `scripts/quick_fix_mypy.py` | 92 | blank line contains whitespace |
| 7663 | E302 | `scripts/quick_fix_mypy.py` | 89 | expected 2 blank lines, found 1 |
| 7662 | W293 | `scripts/quick_fix_mypy.py` | 50 | blank line contains whitespace |
| 7661 | W293 | `scripts/quick_fix_mypy.py` | 46 | blank line contains whitespace |
| 7660 | W293 | `scripts/quick_fix_mypy.py` | 43 | blank line contains whitespace |
| 7659 | W293 | `scripts/quick_fix_mypy.py` | 40 | blank line contains whitespace |
| 7658 | W293 | `scripts/quick_fix_mypy.py` | 48 | blank line contains whitespace |
| 7657 | W293 | `scripts/quick_fix_mypy.py` | 45 | blank line contains whitespace |
| 7656 | E302 | `scripts/quick_fix_mypy.py` | 31 | expected 2 blank lines, found 1 |
| 7655 | W293 | `scripts/quick_fix_mypy.py` | 28 | blank line contains whitespace |
| 7654 | W293 | `scripts/quick_fix_mypy.py` | 29 | blank line contains whitespace |
| 7653 | W293 | `scripts/quick_fix_mypy.py` | 27 | blank line contains whitespace |
| 7652 | E302 | `scripts/quick_fix_mypy.py` | 22 | expected 2 blank lines, found 1 |
| 7650 | E741 | `scripts/auto_fix_mypy.py` | 499 | ambiguous variable name 'l' |
| 7649 | W293 | `scripts/auto_fix_mypy.py` | 480 | blank line contains whitespace |
| 7648 | W293 | `scripts/auto_fix_mypy.py` | 478 | blank line contains whitespace |
| 7647 | W293 | `scripts/auto_fix_mypy.py` | 472 | blank line contains whitespace |
| 7646 | W293 | `scripts/auto_fix_mypy.py` | 464 | blank line contains whitespace |
| 7645 | W293 | `scripts/auto_fix_mypy.py` | 455 | blank line contains whitespace |
| 7644 | W293 | `scripts/auto_fix_mypy.py` | 453 | blank line contains whitespace |
| 7643 | W293 | `scripts/auto_fix_mypy.py` | 442 | blank line contains whitespace |
| 7642 | W293 | `scripts/auto_fix_mypy.py` | 438 | blank line contains whitespace |
| 7641 | W293 | `scripts/auto_fix_mypy.py` | 436 | blank line contains whitespace |
| 7640 | W293 | `scripts/auto_fix_mypy.py` | 429 | blank line contains whitespace |
| 7639 | W293 | `scripts/auto_fix_mypy.py` | 427 | blank line contains whitespace |
| 7638 | W293 | `scripts/auto_fix_mypy.py` | 380 | blank line contains whitespace |
| 7637 | W293 | `scripts/auto_fix_mypy.py` | 361 | blank line contains whitespace |
| 7636 | W293 | `scripts/auto_fix_mypy.py` | 358 | blank line contains whitespace |
| 7635 | W293 | `scripts/auto_fix_mypy.py` | 356 | blank line contains whitespace |
| 7634 | W293 | `scripts/auto_fix_mypy.py` | 354 | blank line contains whitespace |
| 7633 | W293 | `scripts/auto_fix_mypy.py` | 345 | blank line contains whitespace |
| 7632 | W293 | `scripts/auto_fix_mypy.py` | 340 | blank line contains whitespace |
| 7631 | W293 | `scripts/auto_fix_mypy.py` | 326 | blank line contains whitespace |
| 7630 | W293 | `scripts/auto_fix_mypy.py` | 321 | blank line contains whitespace |
| 7629 | W293 | `scripts/auto_fix_mypy.py` | 307 | blank line contains whitespace |
| 7628 | W293 | `scripts/auto_fix_mypy.py` | 302 | blank line contains whitespace |
| 7627 | W293 | `scripts/auto_fix_mypy.py` | 288 | blank line contains whitespace |
| 7626 | W293 | `scripts/auto_fix_mypy.py` | 283 | blank line contains whitespace |
| 7625 | W293 | `scripts/auto_fix_mypy.py` | 269 | blank line contains whitespace |
| 7624 | W293 | `scripts/auto_fix_mypy.py` | 264 | blank line contains whitespace |
| 7623 | W293 | `scripts/auto_fix_mypy.py` | 250 | blank line contains whitespace |
| 7622 | W293 | `scripts/auto_fix_mypy.py` | 245 | blank line contains whitespace |
| 7621 | W293 | `scripts/auto_fix_mypy.py` | 231 | blank line contains whitespace |
| 7620 | W293 | `scripts/auto_fix_mypy.py` | 226 | blank line contains whitespace |
| 7619 | W293 | `scripts/auto_fix_mypy.py` | 212 | blank line contains whitespace |
| 7618 | W293 | `scripts/auto_fix_mypy.py` | 207 | blank line contains whitespace |
| 7617 | W293 | `scripts/auto_fix_mypy.py` | 193 | blank line contains whitespace |
| 7616 | W293 | `scripts/auto_fix_mypy.py` | 188 | blank line contains whitespace |
| 7615 | W293 | `scripts/auto_fix_mypy.py` | 174 | blank line contains whitespace |
| 7614 | W293 | `scripts/auto_fix_mypy.py` | 168 | blank line contains whitespace |
| 7613 | W293 | `scripts/auto_fix_mypy.py` | 154 | blank line contains whitespace |
| 7612 | W293 | `scripts/auto_fix_mypy.py` | 149 | blank line contains whitespace |
| 7611 | W293 | `scripts/auto_fix_mypy.py` | 135 | blank line contains whitespace |
| 7610 | W293 | `scripts/auto_fix_mypy.py` | 113 | blank line contains whitespace |
| 7609 | W293 | `scripts/auto_fix_mypy.py` | 99 | blank line contains whitespace |
| 7608 | W293 | `scripts/auto_fix_mypy.py` | 67 | blank line contains whitespace |
| 7607 | W293 | `scripts/auto_fix_mypy.py` | 79 | blank line contains whitespace |
| 7606 | W293 | `scripts/auto_fix_mypy.py` | 93 | blank line contains whitespace |
| 7604 | W292 | `opt/webhook_system.py` | 574 | no newline at end of file |
| 7603 | W292 | `opt/web/panel/validation/schemas.py` | 514 | no newline at end of file |
| 7602 | W292 | `opt/web/dashboard/app.py` | 43 | no newline at end of file |
| 7601 | W292 | `opt/testing/test_phase4_integration.py` | 404 | no newline at end of file |
| 7600 | W292 | `opt/testing/test_e2e_comprehensive.py` | 622 | no newline at end of file |
| 7599 | E501 | `opt/testing/mock_mode.py` | 769 | line too long (124 > 120 characters) |
| 7598 | E501 | `opt/testing/mock_mode.py` | 759 | line too long (126 > 120 characters) |
| 7597 | W292 | `opt/system/upgrade_manager.py` | 89 | no newline at end of file |
| 7596 | W292 | `opt/system/passthrough_manager.py` | 283 | no newline at end of file |
| 7595 | W292 | `opt/system/hardware_detection.py` | 869 | no newline at end of file |
| 7594 | W292 | `opt/services/test_phase5_features.py` | 480 | no newline at end of file |
| 7593 | W292 | `opt/services/storage/multiregion_storage.py` | 1174 | no newline at end of file |
| 7592 | W292 | `opt/services/sdn/sdn_controller.py` | 841 | no newline at end of file |
| 7591 | W292 | `opt/services/scheduler/cli.py` | 632 | no newline at end of file |
| 7590 | W292 | `opt/services/scheduler/api.py` | 569 | no newline at end of file |
| 7589 | W292 | `opt/services/rbac/fine_grained_rbac.py` | 577 | no newline at end of file |
| 7588 | W292 | `opt/services/observability/cardinality_controller.py` | 1276 | no newline at end of file |
| 7587 | W292 | `opt/services/network/multitenant_network.py` | 1322 | no newline at end of file |
| 7586 | W292 | `opt/services/multiregion/replication_scheduler.py` | 1167 | no newline at end of file |
| 7585 | W292 | `opt/services/multiregion/cli.py` | 533 | no newline at end of file |
| 7584 | W292 | `opt/services/migration/import_wizard.py` | 1251 | no newline at end of file |
| 7583 | W292 | `opt/services/licensing/licensing_server.py` | 871 | no newline at end of file |
| 7582 | W292 | `opt/services/dns/hosting.py` | 224 | no newline at end of file |
| 7581 | W292 | `opt/services/cost_optimization/cli.py` | 120 | no newline at end of file |
| 7580 | E501 | `opt/services/compliance/reporting.py` | 174 | line too long (1035 > 120 characters) |
| 7579 | W292 | `opt/services/compliance/reporting.py` | 174 | no newline at end of file |
| 7578 | W292 | `opt/security/ssh_hardener.py` | 117 | no newline at end of file |
| 7577 | W292 | `opt/netcfg-tui/backends.py` | 634 | no newline at end of file |
| 7576 | W292 | `opt/models/phase4_models.py` | 425 | no newline at end of file |
| 7575 | W292 | `opt/installer/install_profile_logger.py` | 838 | no newline at end of file |
| 7574 | W292 | `opt/helpers/standardization.py` | 595 | no newline at end of file |
| 7573 | W292 | `opt/graphql_integration.py` | 386 | no newline at end of file |
| 7572 | W292 | `opt/dvctl.py` | 289 | no newline at end of file |
| 7571 | W292 | `opt/deployment/migrations.py` | 525 | no newline at end of file |
| 7570 | W292 | `opt/core/unified_backend.py` | 1064 | no newline at end of file |
...
| 7484 | E302 | `tests/test_dns_hosting.py` | 12 | expected 2 blank lines, found 1 |
...
| 6579 | W293 | `opt/testing/test_phase4_week4.py` | 233 | blank line contains whitespace |
