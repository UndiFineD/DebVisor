...
/etc/systemd/system/debvisor-*.service.d/\n\n## Configuration files should be readable but not
...
-ls\n\n## Timer files should be 0644\n\n find /etc/systemd/system -name "debvisor-*.timer" -type f !
...
Persistence Configuration\n\n### Timer Persistence\n\n## Timers should be configured to survive
reboots\n\n [Timer]\n\n## Run timer on boot if it was missed\n\n OnBootSec=5min\n\n## Persist timer
state across reboots\n\n Persistent=true\n\n## Accuracy settings (balance between timing and system
