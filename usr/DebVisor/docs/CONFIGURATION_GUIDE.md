...
Validation\n\n## Validate all blocklist files\n\n python3 opt/config/validate-blocklist.py --dir
etc/blocklist.d/\n\n## Check specific file\n\n python3 opt/config/validate-blocklist.py --file
...
WantedBy=multi-user.target\n\n### Timer Units\n\n- *debvisor-health-check.timer**- Regular health
