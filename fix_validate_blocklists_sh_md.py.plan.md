# Planning Report: fix_validate_blocklists_sh_md.py

Generated: 2025-12-13T18:59:40.247294
Status: INVALID
...
| incorrect_header | 4 | Header line incorrect: got 'file_path = 'etc/debvisor/validate-blocklists.sh.plan.md'', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 11 | Header line incorrect: got 'content = re.sub(r'(?](\g)', content)', expected '# limitations under the License.' |
...
File: fix_validate_blocklists_sh_md.py
Current Description:
