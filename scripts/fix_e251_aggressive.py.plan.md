...
Generated: 2025-12-13T20:40:16.376635
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Aggressive but safe E251 fix - remove all spaces around = in function calls"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 9 | Header line incorrect: got '# Strategy: Find all function/method calls and fix spacing', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 10 | Header line incorrect: got '# We'll use a regex to find patterns like: word = word (in function args) and replace with word=word', expected '# See the License for the specific language governing permissions and' |
...
File: scripts\fix_e251_aggressive.py
Current Description:
