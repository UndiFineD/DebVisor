...
Generated: 2025-12-13T15:10:42.926824
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got '"""Comprehensive fix for api_key_manager.py with all known issues"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
| incorrect_header | 3 | Header line incorrect: got '', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'with open('opt/services/api_key_manager.py', 'r') as f:', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 7 | Header line incorrect: got 'result = []', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
...
| incorrect_header | 9 | Header line incorrect: got '    # Remove unused os import', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '    if 'import os' in line and i < 50:', expected '# limitations under the License.' |
