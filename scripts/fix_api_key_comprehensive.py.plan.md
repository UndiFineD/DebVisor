...
Generated: 2025-12-13T20:40:16.354041
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Comprehensive fix for api_key_manager.py with all known issues"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 7 | Header line incorrect: got 'result = []', expected '# Unless required by applicable law or agreed to in writing, software' |
...
| incorrect_header | 9 | Header line incorrect: got '    # Remove unused os import', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 10 | Header line incorrect: got '    if 'import os' in line and i < 50:', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 11 | Header line incorrect: got '        continue', expected '# limitations under the License.' |
...
File: scripts\fix_api_key_comprehensive.py
Current Description:
