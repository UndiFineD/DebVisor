...
Generated: 2025-12-13T14:56:11.349996
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got '"""Fix parameter spacing issues"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 9 | Header line incorrect: got 'result_lines = []', expected '# See the License for the specific language governing permissions and' |
