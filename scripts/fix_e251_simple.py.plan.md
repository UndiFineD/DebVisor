...
| incorrect_header | 2 | Header line incorrect: got '"""Simple global E251 fix"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 9 | Header line incorrect: got '# Simple approach: globally replace word = word with word=word', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '# But only within function/method calls (between parentheses)', expected '# limitations under the License.' |
