...
Generated: 2025-12-13T20:12:43.426011
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Fix api_key_manager.py - targeted surgical fixes"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 11 | Header line incorrect: got '    # Line 40: Logger spacing', expected '# limitations under the License.' |
...
File: scripts\fix_api_key_manager_surgical.py
Current Description:
