...
| incorrect_header | 5 | Header line incorrect: got '# Dynamically import fix_markdown_lint from repository root without modifying sys.path', expected '#     [http://www.apache.org/licenses/LICENSE-2.0']([http://www.apache.org/licenses/LICENSE-2.0]([http://www.apache.org/licenses/LICENSE-2.](http://www.apache.org/licenses/LICENSE-2.)0)') |
| incorrect_header | 6 | Header line incorrect: got 'ROOT = Path(__file__).resolve().parents[1]', expected '# Unless required by applicable law or agreed to in writing, software' |
