...
Generated: 2025-12-13T20:40:16.358263
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Final comprehensive fix for api_key_manager.py"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 9 | Header line incorrect: got '# Replace all logger references with _logger', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 10 | Header line incorrect: got 'content = content.replace('logger.info', '_logger.info')', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 11 | Header line incorrect: got 'content = content.replace('logger.warning', '_logger.warning')', expected '# limitations under the License.' |
...
File: scripts\fix_api_key_manager_final.py
Current Description:
