...
Generated: 2025-12-13T14:56:11.358193
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got '"""Fix underscore variable naming inconsistencies"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 9 | Header line incorrect: got '# All underscore variables and their clean versions to replace', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got 'underscore_fixes = {', expected '# limitations under the License.' |
