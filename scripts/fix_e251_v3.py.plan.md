...
Generated: 2025-12-13T14:56:11.337899
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got '"""Fix E251 keyword argument spacing - handles multiline function calls"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
| incorrect_header | 3 | Header line incorrect: got 'import re', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'import glob', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 7 | Header line incorrect: got 'def fix_e251_aggressive(content):', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
...
| incorrect_header | 9 | Header line incorrect: got '    Fix E251 spacing issues more aggressively.', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '    We look for patterns like '   _word = value' or '   word = value'', expected '# limitations under the License.' |
