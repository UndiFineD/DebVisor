...
class TestSeverityScoring:
    ...
    def test_higher_severity_higher_score(self, agent: Any, errors_module: Any) -> None:
        ...
        error_critical = agent.add_error("Critical", "a.py", 10, errors_module.ErrorSeverity.CRITICAL)
    ...
    def test_security_category_increases_score(self, agent: Any, errors_module: Any) -> None:
        ...
        error_normal = agent.add_error("Normal", "a.py", 10, category=errors_module.ErrorCategory.RUNTIME)
        error_security = agent.add_error("Security", "b.py", 20, category=errors_module.ErrorCategory.SECURITY)
