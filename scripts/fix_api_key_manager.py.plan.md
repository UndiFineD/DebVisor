...
Generated: 2025-12-13T19:56:31.663700
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Fix api_key_manager.py flake8 errors"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 10 | Header line incorrect: got 'content = re.sub(r'import os\n', '', content, count=1)', expected '# See the License for the specific language governing permissions and' |
...
File: scripts\fix_api_key_manager.py
Current Description:
