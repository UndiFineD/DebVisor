...
Generated: 2025-12-13T20:40:16.362183
Status: INVALID
...
| Type | Line | Message |
|------|------|---------|
| incorrect_header | 2 | Header line incorrect: got '"""Fix remaining issues in api_key_manager.py"""', expected '# Copyright (c) 2025 DebVisor contributors' |
...
| incorrect_header | 9 | Header line incorrect: got '# Fix keyword argument spacing in function/method calls', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 10 | Header line incorrect: got '# Pattern: func(key = value) should become func(key=value)', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 11 | Header line incorrect: got '# But: func(param: type = default) in def should stay as is', expected '# limitations under the License.' |
...
File: scripts\fix_api_remaining.py
Current Description:
