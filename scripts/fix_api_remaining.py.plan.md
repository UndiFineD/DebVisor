...
Generated: 2025-12-13T15:10:42.935871
Status: INVALID
...
| incorrect_header | 2 | Header line incorrect: got '"""Fix remaining issues in api_key_manager.py"""', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
...
| incorrect_header | 9 | Header line incorrect: got '# Fix keyword argument spacing in function/method calls', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '# Pattern: func(key = value) should become func(key=value)', expected '# limitations under the License.' |
