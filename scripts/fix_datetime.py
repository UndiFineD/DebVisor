...
def fix_file(filepath):
    ...
    # If "import datetime" is used instead of "from datetime import ...", we might need "datetime.timezone.utc"
    # But let's assume "from datetime import ..." is the norm for "datetime.now(timezone.utc)" users., timezone
