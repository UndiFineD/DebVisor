# Planning Report: scripts\planning_agent.py

Generated: 2025-12-13T15:10:42.987092
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Planning Agent: Validates and enforces code file structure.', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got '', expected '# You may obtain a copy of the License at' |
| incorrect_header | 5 | Header line incorrect: got 'Checks that each code file has:', expected '#     [http://www.apache.org/licenses/LICENSE-2.0']([http://www.apache.org/licenses/LICENSE-2.0]([http://www.apache.org/licenses/LICENSE-2.]([http://www.apache.org/licenses/LICENSE-2](http://www.apache.org/licenses/LICENSE-2).)0)') |
| incorrect_header | 6 | Header line incorrect: got '1. LICENSE_HEADER (as comments)', expected '# Unless required by applicable law or agreed to in writing, software' |
| incorrect_header | 7 | Header line incorrect: got '2. Description section (docstring)', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 8 | Header line incorrect: got '3. Changelog section (docstring)', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 9 | Header line incorrect: got '4. Suggested Fixes section (docstring)', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 10 | Header line incorrect: got '5. Improvements section (docstring)', expected '# limitations under the License.' |
