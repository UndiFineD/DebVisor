...
(security)\n-**JavaScript:**eslint\n-**CSS:**stylelint\n-**HTML:**htmlhint\n-**Go:**golangci-lint\n\n**Output:**
`filename.ext.md`- Issue reports with severity levels\n\n**Run:**\n\n```bash\npython3
scripts/critic_agent.py\n\n```text\n\n### 3. Coding Expert Agent
(`coding_expert_agent.py`)\n\n**Purpose:** Analyzes issue reports and generates detailed
fix
...
main()\n\n```text\n\n## Usage Workflow\n\n### Step 1: Run Full
Workflow\n\n```bash\npython3
scripts/unified_workflow.py\n\n```text\n\nThis will:\n\n- Validate file structure across
all code
...
sections\n\n### Step 4: Mark Issues as Fixed\n\nIn the`.md`and`.plan.md`files, mark
completed
fixes:\n\n```markdown\n## Implementation Status\n✅`E501`- Line too long
