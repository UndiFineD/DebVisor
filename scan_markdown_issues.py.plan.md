...
Generated: 2025-12-13T17:06:28.840809
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Extended markdown linting issue scanner.', expected '# you may not use this file except in compliance with the License.' |
| incorrect_header | 4 | Header line incorrect: got 'Identifies additional markdown issues for fix_all_markdown.py', expected '# You may obtain a copy of the License at' |
...
| incorrect_header | 9 | Header line incorrect: got 'import fnmatch', expected '# See the License for the specific language governing permissions and' |
