# Planning Report: scan_markdown_issues.py

Generated: 2025-12-13T18:59:40.768466
Status: INVALID
...
| incorrect_header | 3 | Header line incorrect: got 'Extended markdown linting issue scanner.', expected '# Licensed under the Apache License, Version 2.0 (the "License");' |
| incorrect_header | 4 | Header line incorrect: got 'Identifies additional markdown issues for fix_all_markdown.py', expected '# you may not use this file except in compliance with the License.' |
...
| incorrect_header | 8 | Header line incorrect: got 'import json', expected '# distributed under the License is distributed on an "AS IS" BASIS,' |
| incorrect_header | 9 | Header line incorrect: got 'import fnmatch', expected '# WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.' |
| incorrect_header | 10 | Header line incorrect: got 'from pathlib import Path', expected '# See the License for the specific language governing permissions and' |
| incorrect_header | 11 | Header line incorrect: got 'from collections import defaultdict', expected '# limitations under the License.' |
