...
**Message:** Close matches include ' python3 << 'PYEOF' > "$TEST_ENV/results/dual-stack-test.json"
2>&1\r' (!= 'PYEOF').
...
**Message:** Close matches include ' python3 << 'PYEOF' > "$TEST_ENV/results/overlap-test.json"
2>&1\r' (!= 'PYEOF').
