...
DEBVISOR_ARCH="${DEBVISOR_ARCH:-amd64}"
DEBVISOR_VERSION="${DEBVISOR_VERSION:-}"
DEBVISOR_MIRROR_BOOTSTRAP="${DEBVISOR_MIRROR_BOOTSTRAP:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb](http://deb.debian.org/deb)i)a)n)/)})")
```python
...
DEBVISOR_VERSION="${DEBVISOR_VERSION:-}"
DEBVISOR_MIRROR_BOOTSTRAP="${DEBVISOR_MIRROR_BOOTSTRAP:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb](http://deb.debian.org/deb)i)a)n)/)})")
DEBVISOR_MIRROR_BINARY="${DEBVISOR_MIRROR_BINARY:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb](http://deb.debian.org/deb)i)a)n)/)})")
```python
