...
DEBVISOR_ARCH="${DEBVISOR_ARCH:-amd64}"
DEBVISOR_VERSION="${DEBVISOR_VERSION:-}"
DEBVISOR_MIRROR_BOOTSTRAP="${DEBVISOR_MIRROR_BOOTSTRAP:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb]([http://deb.debian.org/de]([http://deb.debian.org/d]([http://deb.debian.org/]([http://deb.debian.org]([http://deb.debian.or]([http://deb.debian.o]([http://deb.debian.]([http://deb.debian](http://deb.debian).)o)r)g)/)d)e)b)i)a)n)/)})")
```python
...
DEBVISOR_VERSION="${DEBVISOR_VERSION:-}"
DEBVISOR_MIRROR_BOOTSTRAP="${DEBVISOR_MIRROR_BOOTSTRAP:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb]([http://deb.debian.org/de]([http://deb.debian.org/d]([http://deb.debian.org/]([http://deb.debian.org]([http://deb.debian.or]([http://deb.debian.o]([http://deb.debian.]([http://deb.debian](http://deb.debian).)o)r)g)/)d)e)b)i)a)n)/)})")
DEBVISOR_MIRROR_BINARY="${DEBVISOR_MIRROR_BINARY:-[http://deb.debian.org/debian/}"]([http://deb.debian.org/debian/}]([http://deb.debian.org/debian/]([http://deb.debian.org/debian]([http://deb.debian.org/debia]([http://deb.debian.org/debi]([http://deb.debian.org/deb]([http://deb.debian.org/de]([http://deb.debian.org/d]([http://deb.debian.org/]([http://deb.debian.org]([http://deb.debian.or]([http://deb.debian.o]([http://deb.debian.]([http://deb.debian](http://deb.debian).)o)r)g)/)d)e)b)i)a)n)/)})")
```python
