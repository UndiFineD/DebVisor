# Kubernetes addons\n\nThis directory contains optional Kubernetes addons that can be enabled on a

DebVisor cluster.\n\n## Included addons\n\n- **Monitoring stack**(`monitoring/`):\n\n-
`prometheus.yaml`,`grafana.yaml`, and\n\n `prometheus-grafana-placeholder.yaml`provide minimal,
...
-f docker\addons\k8s\monitoring\\n\n- Ensure cluster networking (Calico) is healthy and that any
