...
echo "[http://${HOSTNAME}${VNC_PATH}"]([http://${HOSTNAME}${VNC_PATH}]([http://${HOSTNAME}${VNC_PATH]([http://${HOSTNAME}${VNC_PAT]([http://${HOSTNAME}${VNC*PA]([http://${HOSTNAME}${VNC*P]([http://${HOSTNAME}${VNC*]([http://${HOSTNAME}${VNC]([http://${HOSTNAME}${VN](http://${HOSTNAME}${VN)C)*)P)A)T)H)})")
```python
