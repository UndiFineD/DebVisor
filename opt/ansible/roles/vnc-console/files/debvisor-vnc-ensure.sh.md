...
echo "[http://${HOSTNAME}${VNC_PATH}"]([http://${HOSTNAME}${VNC_PATH}]([http://${HOSTNAME}${VNC_PATH]([http://${HOSTNAME}${VNC_PAT]([http://${HOSTNAME}${VNC_PA]([http://${HOSTNAME}${VNC_P]([http://${HOSTNAME}${VNC_](http://${HOSTNAME}${VNC_)P)A)T)H)})")
```python
