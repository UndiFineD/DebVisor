...
echo "[[http://${HOSTNAME}${VNC_PATH}"]([http://${HOSTNAME}${VNC_PATH}]([http://${HOSTNAME}${VNC_PATH]([http://${HOSTNAME}${VNC_PAT]([http://${HOSTNAME}${VNC*PA]([http://${HOSTNAME}${VNC*P]([http://${HOSTNAME}${VNC*]([http://${HOSTNAME}${VNC]([http://${HOSTNAME}${VN]([http://${HOSTNAME}${V]([http://${HOSTNAME}${]([http://${HOSTNAME}$]([http://${HOSTNAME}]([http://${HOSTNAME]([http://${HOSTNAM]([http://${HOSTNA]([http://${HOSTN]([http://${HOST]([http://${HOS]([http://${HO]([http://${H]([http://${]([http://$](http://](http://${HOSTNAME}${VNC_PATH}"]([http://${HOSTNAME}${VNC_PATH}]([http://${HOSTNAME}${VNC_PATH]([http://${HOSTNAME}${VNC_PAT]([http://${HOSTNAME}${VNC*PA]([http://${HOSTNAME}${VNC*P]([http://${HOSTNAME}${VNC*]([http://${HOSTNAME}${VNC]([http://${HOSTNAME}${VN]([http://${HOSTNAME}${V]([http://${HOSTNAME}${]([http://${HOSTNAME}$]([http://${HOSTNAME}]([http://${HOSTNAME]([http://${HOSTNAM]([http://${HOSTNA]([http://${HOSTN]([http://${HOST]([http://${HOS]([http://${HO]([http://${H]([http://${]([http://$](http://)$){)H)O)S)T)N)A)M)E)})$){)V)N)C)*)P)A)T)H)})")
```python
