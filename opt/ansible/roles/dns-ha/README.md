...
hosts:
debvisor_dns_ha\n\n become: true\n roles:\n\n- dns-ha\n\nThis role is intended to work in
concert
with the`dns-secondary` role\nfor additional secondaries and with on-node TSIG rotation
tooling.\n\n
