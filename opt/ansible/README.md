...
playbooks/site.yml -vv\n\n## Playbook Tags\n\nAll playbooks use tags for selective execution. Common
...
Initializes cluster, not easily reversible\n\n-`security-hardening.yml`- May restrict access; test
...
Hosts\n\n1. Edit inventory file (e.g., `inventory.lab`)\n\n1. Add host under appropriate group with
