...
overrides
(copy and customize)\n +-- inventory.example # Legacy INI format (deprecated, for
reference)\n +--
...
overrides\n +-- all.yml # Variables for all hosts\n +-- dns_primaries.yml # DNS primary
variables\n
+-- dns_secondaries.yml # DNS secondary variables\n +-- ceph_mons.yml # Ceph monitor
variables\n +--
ceph_osds.yml # Ceph OSD variables\n +-- k8s_controlplane.yml # Kubernetes control plane
variables\n
+-- k8s_workers.yml # Kubernetes worker variables\n +-- hypervisors.yml # Hypervisor
variables\n
...
inventory.lab
playbooks/site.yml -vv\n\n## Playbook Tags\n\nAll playbooks use tags for selective
execution. Common
