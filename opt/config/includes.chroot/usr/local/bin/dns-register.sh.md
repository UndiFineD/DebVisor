...
| 241 | 43 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
...
| 245 | 22 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 246 | 16 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 247 | 42 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 248 | 8 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 249 | 26 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
...
| 252 | 26 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 253 | 63 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 254 | 15 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 255 | 3 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 256 | 1 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 257 | 33 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 258 | 78 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 259 | 15 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 260 | 3 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 261 | 1 | shellcheck | `1017` | ERROR | Literal carriage return. Run script through tr -d '\r' . |
| 262 | 1 | shellcheck | `1009` | INFO | The mentioned syntax error was in this simple command. |
| 262 | 5 | shellcheck | `1073` | ERROR | Couldn't parse this here document. Fix to allow more checks. |
| 262 | 7 | shellcheck | `1041` | ERROR | Found 'EOF' further down, but not on a separate line. |
| 262 | 7 | shellcheck | `1042` | ERROR | Close matches include 'EOF\r' (!= 'EOF'). |
...
**Message:** Found 'EOF' further down, but not on a separate line.
...
**Message:** Close matches include 'EOF\r' (!= 'EOF').
