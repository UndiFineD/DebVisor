...
system
packages\n\n-
*storage.list**- Ceph and ZFS\n\n- *network.list**- Networking (Calico,
etc)\n\n-
*optional.list**-
Optional components\n\n## Build Hooks\n\n- *00-preseed**- Validate preseed
syntax\n\n-
...
automatically\n\n-
Configure automatic security updates\n\n- Use strong passwords or disable root
login\n\n##
Validation\n\n## Check preseed syntax\n\n python3
opt/config/validate-packages.py --list
