...
__Problem:__Wi-Fi interface shows "No SSID" after applying config
...
__Problem:__Interfaces connected to bridge can't communicate
...
__Problem:__Network config reverts after reboot
