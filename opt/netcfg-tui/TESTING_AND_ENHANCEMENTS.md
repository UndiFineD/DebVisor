# Network Config TUI - Testing & Enhancement Guide\n\n## Overview\n\nThis guide documents testing

procedures, enhancement opportunities, and advanced use cases for the DebVisor Network Configuration
...
InterfaceConfig("eth0", "wired")\n iface.method = "dhcp"\n config = generate_netplan_yaml([iface],
...
"""Validate WPA PSK (8-63 chars)."""\n if len(psk) < 8:\n return False, "PSK must be at least 8
