...
# Helper Functions
# =============================================================================
def validate_request_data(schemaclass: type, data: Dict[str, Any]) -> Dict[str, Any]:
    """
...
# =============================================================================
def validate_json(schemaclass: type) -> Any:
    """
...
def validate_query_params(schemaclass: type) -> Any:
    """
