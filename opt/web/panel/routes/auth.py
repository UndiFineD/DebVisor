...
@sliding_window_limiter(lambda: f"email:{request.form.get('email', 'unknown')}",
...
@login_required
@sliding_window_limiter(lambda: f"user:{getattr(current_user, 'id', 'anon')}",
