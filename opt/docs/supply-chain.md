...
registry.example.com/debvisor/app:TAG\n\n 1. Verification example (on DebVisor or in a
cluster
...
repository.\n\n##
Admission Policies Overview\n\n- Admission policies ensure that only images meeting
certain criteria
