...
```python
        ...
        try:
            url=f"[https://{host}/redfish/v1/Systems/1"]([https://{host}/redfish/v1/Systems/1]([https://{host}/redfish/v1/Systems/]([https://{host}/redfish/v1/Systems]([https://{host}/redfish/v1/System]([https://{host}/redfish/v1/Syste]([https://{host}/redfish/v1/Syst](https://{host}/redfish/v1/Syst)e)m)s)/)1)")
