...
class ClientRateLimiter:
    ...
    def __init__(self, config: RateLimitConfig, clientid: str) -> None:
        self.config=config
...
class RateLimiter:
    ...
    def get_limiter(self, clientid: str) -> ClientRateLimiter:
    ...
    def set_client_config(self, clientid: str, config: RateLimitConfig) -> None:
    ...
    def try_acquire(self, clientid: str, tokens: int=1) -> Tuple[bool, float]:
        """Try to acquire tokens for a client."""
        _limiter=self.get_limiter(client_id)
        return limiter.try_acquire(tokens)

    def get_client_status(self, clientid: str) -> Dict[str, Any]:
