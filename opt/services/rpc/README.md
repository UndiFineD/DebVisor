...
tenants.\n\n- **CLI
tooling**: on-box commands under `usr/local/bin/`(and future off-box CLIs) that
talk
to`debvisor.v1`.\n\n- **Automation**: CI/CD systems or operators can use the RPC
service
as a
...
authentication, RBAC
authorization, and input validation.\n\n- **Observability**: Structured audit
logging and
health
