...
class BusinessMetrics:
    ...
    def observe(
        ...
        definition = self.METRICS.get(metric_name)
        buckets = definition.buckets if definition and definition.buckets else DEFAULT_LATENCY_BUCKETS
    ...
    def record_dispute_resolution(self, reason: str, resolution_time_seconds: float) -> None:
        ...
        self.observe("debvisor_dispute_resolution_seconds", resolution_time_seconds, {"reason": reason})
    ...
    def record_communication(
        ...
        self.increment("debvisor_communications_sent_total", 1, {"channel": channel, "template": template})
    ...
    def record_compliance_check(self, check_type: str, passed: bool) -> None:
        ...
        self.increment("debvisor_compliance_checks_total", 1, {"check_type": check_type, "result": result})
