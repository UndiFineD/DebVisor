        ...
        try:
            ...
            if rapl_path.exists():
                ...
                if energy_uj_file.exists():
                    ...
                    # Convert to watts (this is simplified; need delta over time)
                    # For now, return estimated power based on typical values
                    return {
                        "power": 45.0,  # Estimated 45W
...
class CarbonFootprintCalculator:
    ...
    async def calculate_footprint(
        ...
        # Average car: 404g CO2/mile (EPA)
        equivalent_km_driven = (total_carbon_grams / 404.0) * 1.609
    ...
    def calculate_energy_consumption(
        ...
        total_power = sum(m.power_watts for m in metrics_in_range)
        average_power = total_power / len(metrics_in_range)
        
        # Calculate peak power
        peak_power = max(m.power_watts for m in metrics_in_range)
