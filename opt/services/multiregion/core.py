...
class MultiRegionManager:
    ...
    def get_replication_status(self, resourceid: str) -> Dict[str, Any]:
    ...
    def get_region_statistics(self, regionid: str) -> Dict[str, Any]:
...
def get_multi_region_manager(configdir: Optional[str] = None) -> MultiRegionManager:
