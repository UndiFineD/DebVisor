...
class MultiRegionAPI:
    ...
    def _error_response(
        self, message: str, error: str="error", status_code: int=400
    ) -> Tuple[Dict[str, Any], int]:
    ...
    def execute_failover(
        ...
        try:
            ...
            if success:
                ...
                return self._error_response(
                    f"Failover failed: {event.notes}", "failover_error", 500
                )
    ...
    def replicate_vm(self, requestdata: Dict[str, Any]) -> Tuple[Dict[str, Any], int]:
...
def create_flask_app(manager: Optional[MultiRegionManager] = None) -> Any:
    ...
    def replication_status(resourceid: str) -> Any:
